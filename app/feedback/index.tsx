...
const Feedback = () => {
 ...
 const changeCheckboxStates = (bool, name) => {
         ...
         // onClick={navigateBack}
          component={
            <AntDesign
              name="close"
              size={24}
              style={[styles.icon, colorStyle, styles.alrtIcon]}
            />
          }/>
</ThemedView>
...
<Button style={styles.imageBox} component={
...
<Button style={styles.btn} component={<Text style={styles.btnText}> Submit </Text>}/>
    </SafeAreaView>
    )
}
