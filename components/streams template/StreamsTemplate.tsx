  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.wrapper}>
        ...
        <View style={styles.wrap}>
          <Button disabled={false} style={styles.iconBox} component={<FontAwesome6 name="download"
            style={[styles.icon, colorStyle, styles.download]} size={20} color="white" />} />
          <Button disabled={false} style={styles.iconBox} component={<FontAwesome6 name="ellipsis-vertical"
