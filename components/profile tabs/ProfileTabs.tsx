...
const ProfileTabs: FC<Props> = ({ icon, text, custom, containerStyle,
handleClick, wrapperStyle, textStyle, iconStyle, isIcon }) => {


  return (
    <Button onClick={handleClick} style={[styles.container, containerStyle]} component={
